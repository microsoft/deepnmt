...
@register_model('adv_transformer_align')
class AdvTransformerAlignModel(AdvTransformerModel):
    """
...
@register_model_architecture('adv_transformer_align', 'adv_transformer_align')
...
@register_model_architecture('adv_transformer_align', 'adv_transformer_wmt_en_de_big_align')
